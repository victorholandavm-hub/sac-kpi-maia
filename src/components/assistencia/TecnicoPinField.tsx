...
import { setTecnicoPin } from "@/app/assistencia/admin-actions";
import { useQuickAction } from "./useQuickAction";
import { PIN_LENGTH } from "@/lib/pinConfig";

export function TecnicoPinField({ name, hasPin }: { name: string; hasPin: boolean }) {
