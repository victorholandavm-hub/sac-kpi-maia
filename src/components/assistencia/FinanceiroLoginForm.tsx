...
import { financeiroSignIn, type FinanceiroFormState } from "@/app/assistencia/financeiro-actions";
import { PIN_LENGTH } from "@/lib/pinConfig";
import { usePinAutoSubmit } from "./usePinAutoSubmit";

export function FinanceiroLoginForm() {
  const [state, formAction, pending] = useActionState<FinanceiroFormState, FormData>(financeiroSignIn, undefined);
