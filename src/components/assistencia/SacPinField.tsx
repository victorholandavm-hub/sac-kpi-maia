...
import { setSacProfilePin } from "@/app/assistencia/admin-actions";
import { useQuickAction } from "./useQuickAction";
import { PIN_LENGTH } from "@/lib/pinConfig";

export function SacPinField({ id, fullName, hasPin }: { id: string; fullName: string; hasPin: boolean }) {
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={() => {
            ...
            run(async () => {
              await setSacProfilePin(id, pin);
              setEditing(false);
              setPin("");
            }, `PIN de ${fullName} definido.`);
          }}
