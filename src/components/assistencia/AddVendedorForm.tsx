...
import { addVendedor, type FormState } from "@/app/assistencia/admin-actions";
import type { Store } from "@/lib/serviceRequests";

export function AddVendedorForm({ stores }: { stores: Store[] }) {
  const [state, formAction, pending] = useActionState<FormState, FormData>(addVendedor, undefined);
