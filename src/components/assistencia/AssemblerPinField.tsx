...
import { setAssemblerPin } from "@/app/assistencia/admin-actions";
import { useQuickAction } from "./useQuickAction";

export function AssemblerPinField({ name, hasPin }: { name: string; hasPin: boolean }) {
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={() => {
            ...
            run(async () => {
              await setAssemblerPin(name, pin);
              setEditing(false);
              setPin("");
