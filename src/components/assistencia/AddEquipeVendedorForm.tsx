...
import { addVendedorComoGerente, type FormState } from "@/app/assistencia/loja-equipe-actions";

export function AddEquipeVendedorForm({ stores }: { stores: { id: string; name: string }[] }) {
  const [state, formAction, pending] = useActionState<FormState, FormData>(addVendedorComoGerente, undefined);
