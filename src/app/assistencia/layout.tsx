...
// diferente (domínio separado, assistencia.lojasmaia.com.br). Sem isso,
// qualquer link de /assistencia/* compartilhado (WhatsApp, etc.) mostra a
// prévia errada ("Painel de KPIs — SAC Maia").
